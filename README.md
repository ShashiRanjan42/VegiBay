...
---
## ER Diagram
![ER Diagram](https://github.com/shashiranjan42/Vegibay/assets/101393428/9383e35e-9638-45e3-9454-cc54e1a6e5f5)
...
* Before running the API server, you should update the database config inside the [application.properties](Vegibay\src\main\resources\application.properties) file. 
